"""
Django settings for django_crypto_crawler project.
...
ROOT_URLCONF = 'django_crypto_crawler.urls'
...
WSGI_APPLICATION = 'django_crypto_crawler.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

# WisdomTreeProject/settings.py
